...
void sGame::Init(){
    ...
    cover.setX(0);
    cover.setY(0);
    cover.setSize(960,544);

    JamEngine::Instance()->setDrawable_ZIndex(&cover,9);

	LeftArea.setZoneBackground(Assets->getTexture(WHITE_BACKGROUND), 0, 0, 240, 544);
	...
	RightArea.setZoneBackground(Assets->getTexture(BLACK_BACKGROUND), 240, 0, 240, 544);
	...
	TotalArea.setZoneBackground(Assets->getTexture(BLACK_BACKGROUND), 0, 0, 960, 544);
...
void sGame::setTransition(){
    ...
    if(Next.Type == AreaType::LEFT_AREA){
        ...
        if(Next.ObstaclesDir == ObstaclesDirection::Top2Bottom)
            RightArea.setSpawnAreaAndDivisions(242, 960, -20, 10);
        else
            RightArea.setSpawnAreaAndDivisions(240, 960, 292, 10);
        ...
        if(Next.ObstaclesDir == ObstaclesDirection::Top2Bottom){
            TotalArea.setSpawnAreaAndDivisions(0, 960, -20, 10);
            TotalArea.setObstaclesSize(40, 15);
        }
        else if(Next.ObstaclesDir == ObstaclesDirection::Bottom2Top){
            TotalArea.setSpawnAreaAndDivisions(0, 960, 292, 10);
            TotalArea.setObstaclesSize(40, 15);
            
        }
        else if(Next.ObstaclesDir == ObstaclesDirection::Left2Right){
            TotalArea.setSpawnAreaAndDivisions(0, 544, -20, 10);
            TotalArea.setObstaclesSize(15, 40);

        }
        else{
            TotalArea.setSpawnAreaAndDivisions(0, 544, 500, 10);
            TotalArea.setObstaclesSize(15, 40);
